    ...
    <div class="history-container">
      <div class="history-header">
        ...
        <div class="header-actions">
          <button class="btn-new" (click)="goToReport()">Reports</button>
          ...
          <tbody>
            <tr *ngFor="let inv of pagedInvoices; let i = index">
              ...
              <td class="actions">
                ...
                <button class="btn-edit" (click)="editInvoice(inv)" title="Edit Invoice">
...
export class HistoryComponent implements OnInit {
  ...
  editInvoice(inv: SavedInvoice): void {
    this.router.navigate(['/invoice'], { state: { editData: inv.data } });
  }
}
